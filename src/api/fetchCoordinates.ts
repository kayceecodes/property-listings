 ...
 */
const fetchCoordinates = (centerCoordinates: CoordinatePair): Promise<GeoJSON.FeatureCollection> => {
 ...
 */
const getRandomCoordinate = ({ longitude: centerLon, latitude: centerLat }: CoordinatePair): CoordinatePair => {
